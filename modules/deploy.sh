...
configure_xml() {
  ...
  3) shift-shift  6) ctrl-scrolllock"
    ...
    local -a args=(
        ...
        --xml "./cpu/feature[@name='ibrs']/@policy=disable"                # CONCEALMENT: Clears IBRS exposure
        --xml "./cpu/feature[@name='sbpb']/@policy=disable"                # CONCEALMENT: Clears Speculative Branch Prediction Barrier exposure
        --xml "./cpu/feature[@name='spec-ctrl']/@policy=disable"            # CONCEALMENT: Clears speculation control exposure
        --xml "./cpu/feature[@name='stibp']/@policy=disable"                # CONCEALMENT: Clears STIBP exposure
        --xml "./cpu/feature[@name='stibp-always-on']/@policy=disable"      # CONCEALMENT: Prevents always-on STIBP exposure
